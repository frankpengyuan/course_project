...
def run(fff1, fff2, fff3, fff4):
	...
	clsier = RandomForestClassifier(n_estimators = 100, min_samples_leaf=20, verbose=1, max_features = 20, n_jobs = -1)
...
def eva(fff1, fff2, fff3, fff4, rocfile):
	...
	plt.plot(fpr, tpr, linewidth=2, label = "randomforest_fea1")
	...
	fpr, tpr, thresholds = roc_curve(y, p, pos_label=1)  
	print auc(fpr, tpr)
	plt.plot(fpr, tpr, linewidth=2, label = "randomforest_fea2")
...
if __name__ == '__main__':
	run("./fea/train_fea1_1", "./fea/train_fea1_2", './fea/train_fea1_2', './localtest/pred_rf1')
	run("./fea/train_fea2_1", "./fea/train_fea2_2", './fea/train_fea2_2', './localtest/pred_rf2')
	eva("fea/train_fea1_2", "localtest/pred_rf1", "fea/train_fea2_2", "localtest/pred_rf2", "rocfigures/roc_rf1.jpg")