...
def eva(fff1, fff2, fff3, fff4, rocfile):
	...
	plt.plot(fpr, tpr, linewidth=2, label = "csvm_fea1")
	...
	fpr, tpr, thresholds = roc_curve(y, p, pos_label=1)  
	print auc(fpr, tpr)
	plt.plot(fpr, tpr, linewidth=2, label = "csvm_fea2")
...
if __name__ == '__main__':
	run("./fea/train_fea1_1", "./fea/train_fea1_2", './fea/train_fea1_2', './localtest/pred_csvm1')
	run("./fea/train_fea2_1", "./fea/train_fea2_2", './fea/train_fea2_2', './localtest/pred_csvm2')
	eva("fea/train_fea1_2", "localtest/pred_csvm1", "fea/train_fea2_2", "localtest/pred_csvm2", "rocfigures/roc_csvm1.jpg")